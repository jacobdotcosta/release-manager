...
@ApplicationScoped
public class SpringBootReleaseUpdateService {
    private static final Logger LOG = Logger.getLogger(SpringBootReleaseUpdateService.class);

    @Inject
    GitService git;

    public void newRelease(GitService.GitConfig bomGitConfig) throws IOException {
